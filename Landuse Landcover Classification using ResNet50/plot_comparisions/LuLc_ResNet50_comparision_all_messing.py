...
test_img_aoi1 = test_img[:, 50:50+400, 600:600+400]
...
predicted_img_16_aoi = test_img_aoi1[:, start_x:start_x+SIZE, start_y:start_y+SIZE]
...
predicted_img_16_aoi_toPlot = ((predicted_img_16_aoi / (2**12-1)) * 255).astype('uint8')
img3 = ax4.imshow(np.transpose(predicted_img_16_aoi_toPlot, (1, 2, 0)))
